...
@section('styles_page_vendors')
    <link href="{{ asset("assets/$theme") }}/vendors/general/bootstrap-select/dist/css/bootstrap-select.css" rel="stylesheet"
        type="text/css">
    ...
    <link href="{{ asset("assets/$theme") }}/vendors/general/bootstrap-datepicker/dist/css/bootstrap-datepicker3.css"
...
@section('content_page')
        ...
        <div class="container-fluid collapse show" class="collapse" id="collapse5">
            ...
            <div class="d-flex justify-content-center align-items-center p-4">
                <span class="kt-switch kt-switch--lg kt-switch--icon">
                    <label>
                        <input type="checkbox"
                            {{ isset($config->asisstance_module_status) ? ($config->asisstance_module_status == 'true' ? 'checked="checked"' : '') : '' }}
                        ...
                        <div class="col-xs-12 col-lg-9">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name_entity" name="name_entity"
                                    value="{{ $config->name_entity ?? old('name_entity', '') }}" required>
                        ...
                        <div class="col-xs-12 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cif" name="cif"
                                    value="{{ $config->cif ?? old('cif', '') }}" required>
                        ...
                        <div class="col-xs-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="address" name="address"
                                    value="{{ $config->address ?? old('address', '') }}" required>
                        ...
                        <div class="col-xs-2 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="tel" name="tel"
                                    value="{{ $config->tel ?? old('tel', '') }}" required>
                        ...
                        <div class="col-xs-2 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="mobile" name="mobile"
                                    value="{{ $config->mobile ?? old('mobile', '') }}">
                        ...
                        <div class="col-xs-2 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tomo" name="tomo"
                                    value="{{ $config->tomo ?? old('tomo', '') }}" required>
                        ...
                        <div class="col-xs-2 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="folio" name="folio"
                                    value="{{ $config->folio ?? old('folio', '') }}" required>
                        ...
                        <div class="col-xs-2 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="num_factura" name="num_factura"
                                    value="{{ $config->num_factura ?? old('num_factura', '') }}" required>
                            </div>
                        </div>
                    </div>
    ...
    <div class="kt-portlet kt-portlet--head-sm">
        ...
        <!-- START CLONE -->
        <div class="container-fluid collapse show" class="collapse" id="collapse1">
            <form action="{{ route('administration_config_ui') }}" method="POST" autocomplete="off">
                <div class="kt-portlet__body">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-xs-12 col-lg-9">
                            <div class="col-xs-12 col-lg-9">
                                ...
                                {{-- creame un input para los tres colores de la app que tenga dentro tres inputs de type color --}}
                                <div class="form-group">
    ...
    <div class="kt-portlet kt-portlet--head-sm">
        ...
        <div class="container-fluid collapse show" class="collapse" id="collapse2">
            <form action="{{ route('administration_config_documentary_manager_data') }}" method="POST"
                autocomplete="off">
                @csrf
                @method('put')
                <div class="kt-portlet__body">
                        ...
                        <div class="col-xs-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="path_gestor" name="path_gestor"
                                    value="{{ isset($config->path_gestor) ? $config->path_gestor : config('backups.default_path_gestor') }}">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="kt-portlet kt-portlet--head-sm">
        ...
        <div class="container-fluid collapse show" class="collapse" id="collapse3">
            <form action="{{ route('administration_config_update_paths_backups_data') }}" method="POST"
                autocomplete="off">
                @csrf
                @method('put')
                <div class="kt-portlet__body">
                        ...
                        <div class="col-xs-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="path_backups_day" id="path_backups_day"
                                    value="{{ isset($config->path_backups_day) ? $config->path_backups_day : config('backups.default_path_backups_day') }}">
                            </div>
                        </div>
                        <div class="col-xs-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="path_backups_week"
                                    ...
                                    value="{{ isset($config->path_backups_day) ? $config->path_backups_week : config('backups.path_backups_week') }}">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="modal_delete_no_work_days" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('administration_config_destroy_no_work_day') }}" method="POST"
                    autocomplete="off">
                    @csrf
                    @method('delete')
    ...
    <div class="modal fade" id="modal_add_no_work_day" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('administration_config_add_no_work_day') }}" method="POST" autocomplete="off"
                    role="presentation">
                    @csrf
                    @method('post')
                    <div class="modal-body text-center">
                        ...
                        <div class="form-group form-group-last">
                            ...
                            <textarea class="form-control" name="description" rows="3"
                                style="margin-top: 0px; margin-bottom: 0px; height: 50px;">{{ old('description') }}</textarea>
                        </div>
    ...
    <div class="modal fade" id="modal_edit_no_work_day" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('administration_config_edit_no_work_day') }}" method="POST" autocomplete="off"
                    role="presentation">
                    @csrf
                    @method('put')
                    <div class="modal-body text-center">
...
@section('js_page_vendors')
    ...
    <script src="{{ asset("assets/$theme") }}/vendors/general/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"
        type="text/javascript"></script>
    <script src="{{ asset("assets/$theme") }}/vendors/custom/components/vendors/bootstrap-datepicker/init.js"
        type="text/javascript"></script>
@endsection
