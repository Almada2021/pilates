...
@section('content_page')
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                ...
                                &nbsp;
                                <a href="#" onclick="addDocumentClient()"
                                    class="btn btn-brand btn-elevate btn-icon-sm" data-toggle="modal"
    ...
    <div class="modal fade" id="modal_delete_documents" tabindex="-1" role="dialog"
    ...
    <div class="modal fade" id="modal_delete_document" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <div class="form-group text-center">
                            ...
                            <input type="text" name="name_document" class="form-control text-center"
                                id="name-document" value="{{ old('name_document') }}" autocomplete="new-password">
                        </div>
                        ...
                        <div class="row pt-4">
                            <div class="col-6 text-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    ...
                                    <label for="img-change-front" data-toggle="kt-tooltip" data-placement="top"
                                    ...
                                    <input type='file' id="img-change-front" style="display:none" name="front"
                                        accept="" />
                                    <br>
                            ...
                            <div class="col-6 text-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    ...
                                    <input type='file' id="img-change-back" style="display:none" name="back"
                                        accept="" />
                                    <br>
                                    {{-- <small>Clic sobre la imagen para cambiar</small> --}}
                                </div>
                    ...
                    <div class="modal-body text-center">
                        <div class="form-group text-center">
                            <label for="name-document-edit" class="form-control-label">Nombre o título del documento
                                *</label>
                            <input type="text" name="name_document" class="form-control text-center"
                                id="name-document-edit" autocomplete="new-password">
                        </div>
                        <small>Si el documento no tiene un reverso puede omitir la imagen o documento reverso</small>
                        <div class="row pt-4">
                            <div class="col-6 text-center">
                            ...
                            <div class="col-6 text-center">
                                ...
                                <a href="#" onclick="confirmDeleteBack()" id="btn-delete-back"
                                    data-toggle="kt-tooltip" data-placement="top" title=""
                                    data-original-title="Eliminar reverso" class="kt-nav__link"><i
                                        class="kt-nav__link-icon flaticon2-close-cross btn-delete-back"></i></a>

                                <div class="d-flex justify-content-center align-items-center">
                                    <label for="img-change-back-edit" data-toggle="kt-tooltip" data-placement="top"
                                        title="" data-original-title="Clic para cambiar">
    ...
    <form action="{{ route('medical_history_compress_by_client') }}" id="modal_pass_compress_by_client_form"
        method="POST" autocomplete="off" role="presentation">
        @csrf
        @method('post')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="form-group text-center">
                            ...
                            <input type="password" name="pass_repeat" id="pass-repeat-1"
                                class="form-control text-center" value="{{ old('pass_repeat') }}"
    ...
    <form action="{{ route('medical_history_compress_by_clients') }}" id="modal_pass_compress_by_clients_form"
        method="POST" autocomplete="off" role="presentation">
        @csrf
        @method('post')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="form-group text-center">
                            ...
                            <input type="password" name="pass_repeat" id="pass-repeat-2"
                                class="form-control text-center" value="{{ old('pass_repeat') }}"
                                autocomplete="new-password">
                        </div>
    ...
    <form action="{{ route('medical_history_compress_all') }}" id="modal_compress_all_form" method="POST"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="form-group text-center">
                            ...
                            <input type="password" name="pass_repeat" id="pass-repeat-3"
                                class="form-control text-center" value="{{ old('pass_repeat') }}"
                                autocomplete="new-password">
                        </div>
