...
<?php $__env->startSection('title'); ?> Plantillas de Sesiones <?php $__env->stopSection(); ?>
              ...
              <?php foreach ($defaultTimes as $key => $defaultTime) { ?>
                <div class="d-flex justify-content-center mb-3">
                  <div class="form-group"><div class="input-group timepicker">
                    <input class="form-control text-center" id="timepicker_schedule_start_<?php echo e($key); ?>" value="" disabled="" type="text">
                  </div>
                </div>
                ...
                <input class="form-control text-center" id="timepicker_schedule_end_<?php echo e($key); ?>" value="" disabled="" type="text">
              </div>
            </div>
            <button class="btn btn-outline-secondary btn-input text-center" type="button"  onclick="changeEditSchedule('<?php echo e($key); ?>')"><i class="flaticon2-add-circular-button"></i>Elegir</button>
          </div>
...
var templateSelected=<?php echo json_encode($idDefault, 15, 512) ?>;
</script>
...
<script src="<?php echo e(asset("assets")); ?>/js/page-template-datatables.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets")); ?>/js/page-template.js" type="text/javascript"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/template.blade.php ENDPATH**/ ?>