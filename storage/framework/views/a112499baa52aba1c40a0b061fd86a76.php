...
<?php $__env->startSection('title'); ?> Mi Horario <?php $__env->stopSection(); ?>
...
<script>
  var employeeSelected=<?php echo json_encode(auth()->user()->id, 15, 512) ?>;
</script>
<script src="<?php echo e(asset("assets")); ?>/js/page-schedule-datatables-employee.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets")); ?>/js/page-shedule.js" type="text/javascript"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/schedule_employee.blade.php ENDPATH**/ ?>