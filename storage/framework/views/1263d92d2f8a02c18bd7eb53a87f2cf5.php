...
<form action="<?php echo e(route('management_client_insert')); ?>"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
                ...
                <div class="modal-body" >
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center align-items-center">
                            ...
                            <img id="img-change-profile" class="" src="<?php echo e(asset("assets/images/user_default.png")); ?>"  />                 
                            </label>
                           ...
                           <div class="row">
                                <div class="col-4">
                                        <div class="form-group">
                                                ...
                                                <input type="number" name="sessions_floor" class="form-control text-center" id="group-sessions-floor"  value="<?php echo e(old('sessions_floor')); ?>"  autocomplete="new-password" >
                                        </div>
                                </div>
                                <div class="col-4">
                                        <div class="form-group">
                                                ...
                                                <input type="number" name="sessions_machine" class="form-control text-center" id="group-sessions-machine"  value="<?php echo e(old('sessions_machine')); ?>"  autocomplete="new-password" >
                                        </div>
                                </div>
                                <div class="col-4">
                                        <div class="form-group">
                                                <label for="group-sessions-individual" class="form-control-label">Sesiones Fisioterapia</label>
                                                <input type="number" name="sessions_individual" class="form-control text-center" id="group-sessions-individual"  value="<?php echo e(old('sessions_individual')); ?>"  autocomplete="new-password" >
                                        </div>
                                </div>
                           </div>
...
<div class="row pt-4">
    ...
    <div class="col-12">
        ...
        <textarea class="form-control" name="observation_document" id="observation_document" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 137px;"><?php echo e(old('observation')); ?></textarea>
        </div>
</div>
</div>
</div>
...
<form action="<?php echo e(route('management_client_add_document')); ?>"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
<?php echo method_field('post'); ?>
<input style="display:none">
...
<form action="<?php echo e(route('management_client_update')); ?>"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('management_client_delete')); ?>" id="form_delete_clients" method="POST" autocomplete="off">
            <?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('management_client_delete')); ?>"  method="POST" autocomplete="off">
<?php echo csrf_field(); ?>
<?php echo method_field('delete'); ?>
...
<script src="<?php echo e(asset("assets")); ?>/js/page-management-client.js" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/management_client.blade.php ENDPATH**/ ?>