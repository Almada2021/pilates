...
<?php $__env->startSection('title'); ?> Horarios <?php $__env->stopSection(); ?>
...
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jscolor/pygment_trac.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jscolor/iehacks.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jscolor/colorjoe.css" rel="stylesheet" type="text/css"/>
...
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jquery-ui-1.12.1/jquery-ui.css" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jquery-context-menu/jquery.contextMenu.css" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jquery-context-menu/jquery.contextMenu.css" rel="stylesheet" type="text/css" />
...
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/general/bootstrap-datetime-picker/css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/general/bootstrap-timepicker/css/bootstrap-timepicker.css" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset("assets")); ?>/css/session-calendar.css" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset("assets")); ?>/css/shedule-calendar.css" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>
          ...
          <div class="form-group">
            ...
            <div class="form-group" id="form-group-time-session">
              ...
              foreach ($days as $key => $day){
                ...
                <div class="row my-2" id="<?php echo e($day); ?>-row-time">
                  <div class="col-5">
                    <label>Hora Entrada <?php echo e($daysEs[$key]); ?></label>
                    <div class="input-group timepicker">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                          <i class="picker-icon la la-clock-o"></i>
                      ...
                      <input class="form-control text-center" id="timepicker_start1_<?php echo e($day); ?>" readonly value=""  type="text" />
                      <div class="fix-timepicker-schedule" id="container-timepicker-fix-left-<?php echo e($day); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-5">
                    <label>Hora Salida <?php echo e($daysEs[$key]); ?></label>
                    <div class="input-group timepicker">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                          <i class="picker-icon la la-clock-o"></i>
                      ...
                      <input class="form-control text-center" id="timepicker_end1_<?php echo e($day); ?>" readonly  value="" type="text" />
                      <div class="fix-timepicker-schedule" id="container-timepicker-fix-right-<?php echo e($day); ?>">
                      </div>
                    </div>
                  </div>

                  <div class="col-5" id="<?php echo e($day); ?>-one-date-in-row">
                    <label>Hora Entrada <?php echo e($daysEs[$key]); ?></label>
                    <div class="input-group timepicker">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                      ...
                      <input class="form-control text-center" id="timepicker_start1_one_<?php echo e($day); ?>" readonly value=""  type="text" />
                      <div class="fix-timepicker-schedule" id="container-timepicker-fix-left-one-<?php echo e($day); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-5" id="<?php echo e($day); ?>-one-date-out-row">
                    <label>Hora Salida <?php echo e($daysEs[$key]); ?></label>
                    <div class="input-group timepicker">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                      ...
                      <input class="form-control text-center" id="timepicker_end1_one_<?php echo e($day); ?>" readonly  value="" type="text" />
                      <div class="fix-timepicker-schedule" id="container-timepicker-fix-right-one-<?php echo e($day); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-2" id="<?php echo e($day); ?>-one-date-delete-row">
                    <label>&nbsp;</label><br>
                    <button onclick="deleteNewTimeAdvance(1, '<?php echo e($day); ?>')" class="btn btn-sm btn-clean btn-icon btn-icon-md" > <i class="flaticon-delete"></i></button>
                  </div>

                  <div class="col-5" id="<?php echo e($day); ?>-two-date-in-row">
                    <label>Hora Entrada <?php echo e($daysEs[$key]); ?></label>
                    <div class="input-group timepicker">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                      ...
                      <input class="form-control text-center" id="timepicker_start1_two_<?php echo e($day); ?>" readonly value=""  type="text" />
                      <div class="fix-timepicker-schedule" id="container-timepicker-fix-left-two-<?php echo e($day); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-5" id="<?php echo e($day); ?>-two-date-out-row">
                    <label>Hora Salida <?php echo e($daysEs[$key]); ?></label>
                    <div class="input-group timepicker">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                      ...
                      <input class="form-control text-center" id="timepicker_end1_two_<?php echo e($day); ?>" readonly  value="" type="text" />
                      <div class="fix-timepicker-schedule" id="container-timepicker-fix-right-two-<?php echo e($day); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="col-2" id="<?php echo e($day); ?>-two-date-delete-row">
                    <label>&nbsp;</label><br>
                    <button onclick="deleteNewTimeAdvance(2, '<?php echo e($day); ?>')" class="btn btn-sm btn-clean btn-icon btn-icon-md" > <i class="flaticon-delete"></i></button>
                  </div>

                  <div class="col-12">
                    <br>
                    <button type="button" id="<?php echo e($day); ?>-btn-one-new-date" onclick="addNewDateAdvance(1, '<?php echo e($day); ?>')" class="btn btn-outline-secondary btn-lg btn-block">Agregar horario 1</button>
                    <button type="button" id="<?php echo e($day); ?>-btn-two-new-date" onclick="addNewDateAdvance(2, '<?php echo e($day); ?>')" class="btn btn-outline-secondary btn-lg btn-block">Agregar horario 2</button>
                  </div>
...
<script src="<?php echo e(asset("assets/$theme")); ?>/vendors/general/bootstrap-datetime-picker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets/$theme")); ?>/vendors/general/bootstrap-timepicker/js/bootstrap-timepicker.min.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/components/vendors/bootstrap-timepicker/init.js" type="text/javascript"></script>
...
<script src="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jquery-ui-1.12.1/jquery-ui.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jquery-context-menu/jquery.ui.position.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jquery-context-menu/jquery.contextMenu.js" type="text/javascript"></script>

<script src="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jscolor/scale.fix.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets/$theme")); ?>/vendors/custom/jscolor/colorjoe.js" type="text/javascript"></script>


<script src="<?php echo e(asset("assets")); ?>/js/page-schedule-datatables.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets")); ?>/js/page-shedule.js" type="text/javascript"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/schedule.blade.php ENDPATH**/ ?>