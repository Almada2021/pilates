...
<html lang="es">
	...
	<head>
		<meta charset="utf-8" />
		<title><?php echo $__env->yieldContent('title','Studio Pilates Sandra Galán'); ?></title>
		...
		<!--begin::Page Vendors Styles(used by this page) -->
         <?php echo $__env->yieldContent('styles_page_vendors'); ?>
		...
		<link href="<?php echo e(asset("assets/css")); ?>/pace.css" rel="stylesheet" type="text/css" />
		<!--begin::Custom Global Theme Styles(used by all pages) -->
	</head>
	...
	<div class="overlay-pilates" id="overlay-pilates">
			<div class="img-overlay  d-flex justify-content-center align-items-center">
				<div class="text-center">
					   <img class="img-overlay-1 m-4" src="<?php echo e(asset("assets/images")); ?>/logo-mobile-transparent.png" alt="">
						 <br>
					   <img class="img-overlay-2" src="<?php echo e(asset("assets/images")); ?>/loading2.gif" alt="">
				</div>
			</div>
		</div>
	</div>
	...
	<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subheader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading ">
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="/">
					<img  class="logo-dashboard-mobile" alt="Logo" src="<?php echo e(asset("assets")); ?>/images/logo-dashboard.png" />
				</a>
			</div>
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page"><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/metronic/parts/head.blade.php ENDPATH**/ ?>