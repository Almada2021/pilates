...
<?php $__env->startSection('title'); ?> Productos <?php $__env->stopSection(); ?>
...
<form action="<?php echo e(route('management_product_insert')); ?>"  method="POST" autocomplete="off" role="presentation">
<?php echo csrf_field(); ?>
...
<input type="text" name="name" class="form-control text-center" id="name"  value="<?php echo e(old('name')); ?>"  autocomplete="new-password" required>
</div>
...
<input type="number"  step="1" name="sessions_machine" class="form-control text-center" id="sessions_machine"  value="<?php echo e(old('sessions_machine',0)); ?>"  autocomplete="new-password" >
</div>
</div>
<div class="col-xs-12 col-4">
<div class="form-group">
<label for="sessions_floor" class="form-control-label">S.de Suelo *</label>
<input type="number" step="1" name="sessions_floor" class="form-control text-center" id="sessions_floor"  value="<?php echo e(old('sessions_floor',0)); ?>"  autocomplete="new-password" >
</div>
</div>
<div class="col-xs-12 col-4">
<div class="form-group">
<label for="sessions_individual" class="form-control-label">S.de Individuales *</label>
<input type="number" step="1" name="sessions_individual" class="form-control text-center" id="sessions_individual"  value="<?php echo e(old('sessions_individual',0)); ?>"  autocomplete="new-password" >
</div>
</div>
</div>
...
<input type="number" step="any" name="tax" class="form-control text-center" id="tax" oninput="updateFullPrice()" value="<?php echo e(old('tax',0)); ?>" >
</div>
</div>
</div>
<div class="col-xs-12 col-4">               
...
<input type="number" step="any" name="price" class="form-control text-center" id="price" oninput="updateFullPrice()"  value="<?php echo e(old('price')); ?>"  readonly>
</div>
</div>
</div>
...
<input type="number" step="any" name="price_all" class="form-control text-center" id="price_all" oninput="updateFullPrice()" value="<?php echo e(old('price_all')); ?>" required >
</div>
</div>
</div>
</div>
...
<form action="<?php echo e(route('management_product_update')); ?>"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
...
<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('management_product_delete')); ?>" id="form_delete_products" method="POST" autocomplete="off">
            <?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('management_product_delete')); ?>"  method="POST" autocomplete="off">
<?php echo csrf_field(); ?>
<?php echo method_field('delete'); ?>
...
<script src="<?php echo e(asset("assets")); ?>/js/page-management-product.js" type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/management_product.blade.php ENDPATH**/ ?>