...
<?php $__env->startSection('title'); ?> Facturación <?php $__env->stopSection(); ?>
...
<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('administration_billing_delete')); ?>" id="form_delete_clients" method="POST" autocomplete="off">
            <?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('administration_billing_delete')); ?>"  method="POST" autocomplete="off">
<?php echo csrf_field(); ?>
<?php echo method_field('delete'); ?>
...
<script src="<?php echo e(asset("assets")); ?>/js/page-administration-billing.js" type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/administration_billing.blade.php ENDPATH**/ ?>