...
<?php $__env->startSection('title'); ?> Copias de Seguridad <?php $__env->stopSection(); ?>
...
<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('administration_backup_delete')); ?>"  method="POST" autocomplete="off">
            <?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('administration_backup_restore_by_id')); ?>" id="form-for-restore"  method="POST" autocomplete="off">
<?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('administration_backup_backup_rename')); ?>"  method="POST" autocomplete="off">
<?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('administration_backup_create_backup_full')); ?>" method="POST" autocomplete="off">
<?php echo csrf_field(); ?>
<?php echo method_field('post'); ?>
<div class="modal-body">
<h1 class="text-uppercase text-center" style="font-size: 20px;">  <i class="flaticon-danger text-danger display-1"></i>
...
<form action="<?php echo e(route('administration_backup_restore_by_file')); ?>"  method="POST" autocomplete="off" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
<?php echo method_field('post'); ?>
...
<script src="<?php echo e(asset("assets")); ?>/js/page-administration-backup.js" type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/administration_backup.blade.php ENDPATH**/ ?>