...
<link href="<?php echo e(asset("assets/$theme")); ?>/vendors/general/bootstrap-select/dist/css/bootstrap-select.css"
...
<?php echo PilatesHelper::getBreadCrumbs([['route' => route('medical_history'), 'name' => 'Historial Clínico']]); ?>
...
<form action="<?php echo e(route('medical_history_add_document')); ?>" method="POST" autocomplete="off" role="presentation"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <div class="form-group text-center">
                        ...
                        <input type="text" name="name_document" class="form-control text-center" id="name-document"
                            value="<?php echo e(old('name_document')); ?>" autocomplete="new-password">
                    </div>
                    <div class="form-group text-center">
                        ...
                        <input type="date" name="date_document" class="form-control text-center" id="date-document"
                            value="<?php echo e(old('date_document')); ?>" autocomplete="new-password">
                    </div>
                    <div class="row pt-4">
                        <div class="col-12">
                            <div class="form-group form-group-last">
                                ...
                                <textarea class="form-control" name="observation" id="observation" rows="3"
                                    style="margin-top: 0px; margin-bottom: 0px; height: 40vh; resize:none;"><?php echo e(old('observation')); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="d-flex justify-content-between align-items-center w-100 px-5 py-2">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <label for="img-change-front" data-toggle="kt-tooltip" data-placement="top" title=""
                                    ...
                                    <img id="preview-front-document" class="preview-document"
                                        src="<?php echo e(asset('assets')); ?>/images/doc-front-default.png" />
                                </label>
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <label for="img-change-back" data-toggle="kt-tooltip" data-placement="top" title=""
                                    ...
                                    <img id="preview-back-document" class="preview-document"
                                        src="<?php echo e(asset('assets')); ?>/images/doc-back-default.png" />
                                </label>
                    ...
                    <div id="speech" class="btn btn-primary rounded-full ">
                        <image id="microphone-img" src="<?php echo e(asset('assets')); ?>/images/microphone.png" />
                    </div>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="modal_edit_document_client" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('medical_history_update_document')); ?>" id="edit-document-form"
                    enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('medical_history_compress_by_client')); ?>" id="modal_pass_compress_by_client_form" method="POST"
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="form-group text-center">
                        ...
                        <input type="text" name="title" id="title-1" class="form-control text-center"
                            value="<?php echo e(old('title')); ?>" autocomplete="new-password">
                    </div>
                    ...
                    <div class="form-group text-center">
                        ...
                        <input type="password" name="pass" id="pass-1" class="form-control text-center"
                            value="<?php echo e(old('pass')); ?>" autocomplete="new-password">
                    </div>
                    ...
                    <div class="form-group text-center">
                        ...
                        <input type="password" name="pass_repeat" id="pass-repeat-1" class="form-control text-center"
                            value="<?php echo e(old('pass_repeat')); ?>" autocomplete="new-password">
                    </div>
...
<form action="<?php echo e(route('medical_history_compress_by_clients')); ?>" id="modal_pass_compress_by_clients_form" method="POST"
    autocomplete="off" role="presentation">
    <?php echo csrf_field(); ?>
    <?php echo method_field('post'); ?>
...
<form action="<?php echo e(route('medical_history_compress_all')); ?>" id="modal_compress_all_form" method="POST" autocomplete="off"
    role="presentation">
    <?php echo csrf_field(); ?>
    <?php echo method_field('post'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/medical_history.blade.php ENDPATH**/ ?>