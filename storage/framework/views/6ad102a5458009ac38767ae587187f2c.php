...
<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('management_sale_delete')); ?>"  method="POST" autocomplete="off">
            <?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset("assets")); ?>/js/page-management-sale.js" type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/management_sale.blade.php ENDPATH**/ ?>