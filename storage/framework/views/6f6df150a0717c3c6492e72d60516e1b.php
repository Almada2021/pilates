...
<?php $__env->startSection('title'); ?> Listados <?php $__env->stopSection(); ?>
...
<script>
    var statusModuleAssitances=<?php echo json_encode($statusModuleAssitances, 15, 512) ?>;
</script>
<script src="<?php echo e(asset("assets")); ?>/js/page-report-listings.js" type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/report_listings.blade.php ENDPATH**/ ?>