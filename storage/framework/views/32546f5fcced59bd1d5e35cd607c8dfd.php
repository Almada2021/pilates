...
<?php $__env->startSection('title'); ?> Historial Clínico <?php $__env->stopSection(); ?>
...
<form action="<?php echo e(route('medical_history_delete_document')); ?>"  method="POST" autocomplete="off">
<?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('medical_history_add_document')); ?>"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <input type="text" name="name_document" class="form-control text-center" id="name-document"  value="<?php echo e(old('name_document')); ?>"  autocomplete="new-password"  >
    </div>
    ...
    <div class="row pt-4">
        <div class="col-6 text-center">
            ...
            <div class="d-flex justify-content-center align-items-center">
                    ...
                    <img id="preview-front-document" class="preview-document" src="<?php echo e(asset("assets")); ?>/images/doc-front-default.png"  />                 
                    </label>
        ...
        <div class="col-6 text-center">
                ...
                <div class="d-flex justify-content-center align-items-center">
                        <label for="img-change-back"  data-toggle="kt-tooltip" data-placement="top" title="" data-original-title="Clic para cambiar">
                                <img id="preview-back-document" class="preview-document" src="<?php echo e(asset("assets")); ?>/images/doc-back-default.png"  />                 
                                </label>
    ...
    <form action="<?php echo e(route('medical_history_update_document')); ?>"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="row pt-4">
            <div class="col-6 text-center">
                ...
                <div class="d-flex justify-content-center align-items-center">
                        ...
                        <img id="preview-front-document-edit" class="preview-document" src="<?php echo e(asset("assets")); ?>/images/doc-front-default.png"  />                 
                        </label>
            ...
            <div class="col-6 text-center">
                ...
                <div class="d-flex justify-content-center align-items-center">
                        ...
                        <img id="preview-back-document-edit" class="preview-document" src="<?php echo e(asset("assets")); ?>/images/doc-back-default.png"  />                 
                        </label>
            ...
            <div class="col-12">
                    ...
                    <textarea class="form-control" name="observation" id="observation-edit" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 137px;"><?php echo e(old('observation')); ?></textarea>
                    </div>
            </div>
        </div>
        </div>
...
<form action="<?php echo e(route('medical_history_compress_by_client')); ?>" id="modal_pass_compress_by_client_form" method="POST" autocomplete="off" role="presentation">
<?php echo csrf_field(); ?>
<?php echo method_field('post'); ?>
...
<input type="text" name="title" id="title-1" class="form-control text-center"  value="<?php echo e(old('title')); ?>"  autocomplete="new-password"  >
</div>
...
<input type="password" name="pass" id="pass-1" class="form-control text-center"  value="<?php echo e(old('pass')); ?>"  autocomplete="new-password"  >
</div>

<div class="form-group text-center">
<label for="pass-repeat-1" class="form-control-label">Repetir contraseña</label>
<input type="password" name="pass_repeat" id="pass-repeat-1" class="form-control text-center"  value="<?php echo e(old('pass_repeat')); ?>"  autocomplete="new-password"  >
</div>
...
<form action="<?php echo e(route('medical_history_compress_by_clients')); ?>" id="modal_pass_compress_by_clients_form" method="POST" autocomplete="off" role="presentation">
<?php echo csrf_field(); ?>
<?php echo method_field('post'); ?>
...
<input type="text" name="title" id="title-2" class="form-control text-center"  value="<?php echo e(old('title')); ?>"  autocomplete="new-password"  >
</div>
<small>Para no establecer una contraseña deje los campos vacíos</small> 
<div class="form-group text-center">
<label for="pass-2" class="form-control-label">Contraseña</label>
<input type="password" name="pass" id="pass-2" class="form-control text-center"  value="<?php echo e(old('pass')); ?>"  autocomplete="new-password"  >
</div>

<div class="form-group text-center">
<label for="pass-repeat-2" class="form-control-label">Repetir contraseña</label>
<input type="password" name="pass_repeat" id="pass-repeat-2" class="form-control text-center"  value="<?php echo e(old('pass_repeat')); ?>"  autocomplete="new-password"  >
</div>
...
<form action="<?php echo e(route('medical_history_compress_all')); ?>" id="modal_compress_all_form" method="POST" autocomplete="off" role="presentation">
<?php echo csrf_field(); ?>
<?php echo method_field('post'); ?>
...
<input type="text" name="title" id="title-3" class="form-control text-center"  value="<?php echo e(old('title')); ?>"  autocomplete="new-password"  >
</div>
<small>Para no establecer una contraseña deje los campos vacíos</small> 
<div class="form-group text-center">
<label for="pass-3" class="form-control-label">Contraseña</label>
<input type="password" name="pass" id="pass-3" class="form-control text-center"  value="<?php echo e(old('pass')); ?>"  autocomplete="new-password"  >
</div>

<div class="form-group text-center">
<label for="pass-repeat-3" class="form-control-label">Repetir contraseña</label>
<input type="password" name="pass_repeat" id="pass-repeat-3" class="form-control text-center"  value="<?php echo e(old('pass_repeat')); ?>"  autocomplete="new-password"  >
</div>
...
<input type="hidden" name="_token2" id="token_ajax2" value="<?php echo e(Session::token()); ?>">
                <!-- end:: Content -->
...
<script src="<?php echo e(asset("assets")); ?>/js/page-medical-history.js" type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /workspaces/pilates/resources/views/medical_history.blade.php ENDPATH**/ ?>