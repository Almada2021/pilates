...
<img class="logo-dashboard-long" alt="Logo" src="<?php echo e(url('assets/images/logo-dashboard.png')); ?>" />
</a>
</div>
...
<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    ...
    <ul class="kt-menu__subnav">
        ...
        <?php endif; ?>
        <?php if(PilatesHelper::getRolPermissionStatus(null,'administration_backup',false)): ?>
        <li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('administration_backup')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('administration_backup')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Copias de Seguridad</span></a></li>
        <?php endif; ?>
        <?php if(PilatesHelper::getRolPermissionStatus(null,'template',false)): ?>
        <li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('template')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('template')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Plantillas</span></a></li>
        <?php endif; ?>

        <?php if(PilatesHelper::getRolPermissionStatus(null,'schedule',false)): ?>
        <li  class="kt-menu__item   <?php echo e(PilatesHelper::getMenuEnable('schedule')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('schedule')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Horarios</span></a></li>
        <?php endif; ?>

        <?php if(PilatesHelper::getRolPermissionStatus(null,'audit',false)): ?>
        <li  class="kt-menu__item   <?php echo e(PilatesHelper::getMenuEnable('audit')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('audit')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Auditorias (logs)</span></a></li>
        <?php endif; ?>
...
<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    ...
    <?php if(PilatesHelper::getRolPermissionStatus(null,'administration_sale',false)): ?>
    <li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('administration_sale')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('administration_sale')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">TPV (Ventas)</span></a></li>
    <?php endif; ?>
<?php if(PilatesHelper::getRolPermissionStatus(null,'dashboard')): ?>
<li  class="kt-menu__item   <?php echo e(PilatesHelper::getMenuEnable('dashboard') || PilatesHelper::getMenuEnable('/')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('dashboard')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Planificador</span></a></li>
<?php endif; ?>
<?php if(PilatesHelper::getRolPermissionStatus(null,'administration_billing',false)): ?>
<li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('administration_billing')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('administration_billing')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Facturación</span></a></li>
<?php endif; ?>
<?php if(PilatesHelper::getRolPermissionStatus(null,'report_report_cash_register',false)): ?>
<li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('report_report_cash_register')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('report_report_cash_register')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Arqueo Diario</span></a></li>
<?php endif; ?>
...
<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    ...
    <?php endif; ?>
    <?php if(PilatesHelper::getRolPermissionStatus(null,'management_employee',false)): ?>
    <li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('management_employee')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('management_employee')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Empleados</span></a></li>
    <?php endif; ?>
    <?php if(PilatesHelper::getRolPermissionStatus(null,'management_room_group',false)): ?>
    <li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('management_room_group')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('management_room_group')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Salas y Grupos</span></a></li>
    <?php endif; ?>
    <?php if(PilatesHelper::getRolPermissionStatus(null,'management_sale',false)): ?>
    <li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('management_sale')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('management_sale')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Registro Ventas</span></a></li>
    <?php endif; ?>
    </ul>
    </div>
</li>
...
<?php if(PilatesHelper::getRolPermissionStatus(null,'schedule_employee',true)): ?>
<li  class="kt-menu__item   <?php echo e(PilatesHelper::getMenuEnable('schedule_employee')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('schedule_employee')); ?>" class="kt-menu__link "><span class="kt-menu__link-icon">
...
<?php if(PilatesHelper::getRolPermissionStatus(null,'medical_history',false)): ?>
<li  class="kt-menu__item   <?php echo e(PilatesHelper::getMenuEnable('medical_history')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('medical_history')); ?>" class="kt-menu__link "><span class="kt-menu__link-icon">
...
<li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--open" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    ...
    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
    <ul class="kt-menu__subnav">
    <?php if(PilatesHelper::getRolPermissionStatus(null,'report_report_listings',false)): ?>
    <li class="kt-menu__item  <?php echo e(PilatesHelper::getMenuEnable('report_report_listings')? 'kt-menu__item--active ' : ''); ?>" aria-haspopup="true"><a href="<?php echo e(route('report_report_listings')); ?>" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Listados</span></a></li>
    <?php endif; ?>
    </ul>
    </div>
</li>
...
<!-- end:: Aside --><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/metronic/parts/aside.blade.php ENDPATH**/ ?>