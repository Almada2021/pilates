...
<?php $__env->startSection('title'); ?> Planificador <?php $__env->stopSection(); ?>
...
<input  class="form-control text-center" id="group-name-1" name="group_name" value="<?php echo e(old('group_name')); ?>" readonly required>
<div class="input-group-prepend">
...
<input type="hidden" name="id_group" value="<?php echo e(old('id_group')); ?>" id="group-id-1">
</div>
...
<div class="form-group">
  ...
  <a href="<?php echo e(route('schedule')); ?>" target="_blank" style="max-width:35px;" class="btn btn-secondary text-center p-1" ><i style="color:#000 !important;" class="flaticon-calendar-with-a-clock-time-tools pr-1"></i></a>
  </div>
  <input  class="form-control text-center" id="employee-name-1" name="employee_name" value="<?php echo e(old('employee_name')); ?>" readonly required>
  <div class="input-group-prepend">
...
<input type="hidden" name="id_client" id="client-id-1" value="<?php echo e(old('id_client')); ?>" readonly>
</div>
<div class="form-group form-group-last">
<label for="group-observation">Observaciones</label>
<textarea class="form-control" name="observation" id="group-observation" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 50px;"><?php echo e(old('observation')); ?></textarea>
</div>
</div>
...
<div class="modal fade" id="modal_add_new_session" tabindex="-1" role="dialog"   aria-hidden="true">
  ...
  <textarea class="form-control" name="observation" id="group-observation-2" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 50px;"><?php echo e(old('observation')); ?></textarea>
  </div>
  </div>
  <div class="modal-footer">
  <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
      ...
      <div class="row">
        <div class="col-6">
          <div class="d-flex justify-content-start align-items-center">
              ...
              <button type="button" onclick="showModalAddEmployee()" class="btn btn-primary float-right mx-2" ><i class="flaticon2-add-circular-button"></i>Nuevo Empleado</button>
              <a type="button" href="<?php echo e(route('schedule')); ?>" target="_blank" class="btn btn-primary float-right mx-2" ><i class="flaticon2-add-circular-button"></i>Ver Horarios En otra ventana</a>
...
<div class="modal fade" id="modal_add_employee" tabindex="-1" role="dialog"   aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
          ...
          <form action="<?php echo e(route('dashboard_create_employee')); ?>" id="form-add-employee"  method="POST" autocomplete="off" role="presentation" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
              ...
              <div class="row">
                 ...
                 <div class="col-6">
                      ...
                      <div class="form-group">
                              ...
                              <input type="date" name="date_of_birth" class="form-control text-center" id="recipient-date-of-birth"  value="<?php echo e(old('date_of_birth')); ?>" required >
                      </div>
                      <div class="form-group">
...
<script src="<?php echo e(asset("assets")); ?>/js/page-dashboard-datatables.js" type="text/javascript"></script>
<script src="<?php echo e(asset("assets")); ?>/js/page-dashboard.js" type="text/javascript"></script>

<?php $__env->stopSection(); ?>

<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/dashboard.blade.php ENDPATH**/ ?>