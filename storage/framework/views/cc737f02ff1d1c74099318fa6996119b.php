...
<?php $__env->startSection('title'); ?> Salas y Grupos <?php $__env->stopSection(); ?>
...
<div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('management_room_group_room_insert')); ?>"  method="POST" autocomplete="off" >
            <?php echo csrf_field(); ?>
        ...
        <div class="modal-body" >
                <div class="form-group">
                        ...
                        <option class="text-capitalize" value="" <?php echo e(old('type_room')?'':'selected'); ?>  disabled>Seleccionar tipo de sala</option>
                     
                        <option class="text-capitalize" value="Máquina" <?php echo e(old('type_room')? ('machine'==old('type_room'))? 'selected':'' :''); ?>>Máquina</option>
                        <option class="text-capitalize" value="Suelo" <?php echo e(old('type_room')? ('floor'==old('type_room'))? 'selected':'' :''); ?>>Suelo</option>
                        <option class="text-capitalize" value="Camilla" <?php echo e(old('type_room')? ('stretcher'==old('type_room'))? 'selected':'' :''); ?>>Camilla</option>
                        </select>
                </div>
                <div class="form-group">
                        <label for="room-name" class="form-control-label">Nombre *</label>
                        <input type="text" name="name" class="form-control" id="room-name"  value="<?php echo e(old('name')); ?>"  autocomplete="new-password" required>
                </div>
                <div class="form-group">
                        <label for="capacity" class="form-control-label">Capacidad *</label>
                        <input type="number" name="capacity" class="form-control" id="capacity"  value="<?php echo e(old('capacity')); ?>"  autocomplete="new-password" required>
                </div>
                <div class="form-group form-group-last">
                        <label for="observation">Observaciones</label>
                        <textarea class="form-control" name="observation" id="observation" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 50px;"><?php echo e(old('observation')); ?></textarea>
               </div>
        </div>
...
<div class="modal fade" id="modal_edit_room" tabindex="-1" role="dialog"   aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('management_room_group_room_update')); ?>"  method="POST" autocomplete="off" >
                    <?php echo csrf_field(); ?>
...
<div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
        ...
        <form action="<?php echo e(route('management_room_group_room_delete')); ?>" id="form_delete_rooms" method="POST" autocomplete="off">
            <?php echo csrf_field(); ?>
...
<form action="<?php echo e(route('management_room_group_room_delete')); ?>"  method="POST" autocomplete="off">
<?php echo csrf_field(); ?>
<?php echo method_field('delete'); ?>
...
<div class="modal fade" id="modal_delete_group" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true">
    ...
    <form action="<?php echo e(route('management_room_group_group_delete')); ?>"  method="POST" autocomplete="off">
    <?php echo csrf_field(); ?>
    <?php echo method_field('delete'); ?>
...
<div class="modal fade" id="modal_delete_groups" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"  aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('management_room_group_group_delete')); ?>" id="form_delete_groups" method="POST" autocomplete="off">
                <?php echo csrf_field(); ?>
                <?php echo method_field('delete'); ?>
...
<form action="<?php echo e(route('management_room_group_group_insert')); ?>"  method="POST" autocomplete="off" >
<?php echo csrf_field(); ?>
<?php echo method_field('post'); ?>
...
<input type="text" name="name" class="form-control" id="group-name"  value="<?php echo e(old('name')); ?>"  autocomplete="new-password" required>
</div>
<div class="form-group">
<label for="group-level" class="form-control-label">Nivel *</label>
<input type="number" name="level" class="form-control" id="group-level"  value="<?php echo e(old('level')); ?>"  autocomplete="new-password" required>
</div>
...
<input  class="form-control" id="group-name-employee" name="group_name_employee" value="<?php echo e(old('group_name_employee')); ?>" readonly required>
</div>
<input type="hidden" name="id_employee" value="<?php echo e(old('id_employee')); ?>" id="group-id-employee">
</div>
...
<input  class="form-control" id="group-name-room" name="group_name_room" value="<?php echo e(old('group_name_room')); ?>" readonly required>
</div>
<input type="hidden" name="id_room" id="group-id-room" value="<?php echo e(old('id_room')); ?>" readonly>
</div>
...
<div class="modal fade" id="modal_edit_group" tabindex="-1" role="dialog"   aria-hidden="true">
    ...
    <form action="<?php echo e(route('management_room_group_group_update')); ?>"  method="POST" autocomplete="off" >
    <?php echo csrf_field(); ?>
    <?php echo method_field('put'); ?>
...
<script src="<?php echo e(asset("assets")); ?>/js/page-room-and-group.js" type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make("$theme/layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u238205865/domains/classerp.es/public_html/pilatessg/resources/views/room_and_group.blade.php ENDPATH**/ ?>